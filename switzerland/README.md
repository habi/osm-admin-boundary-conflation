...
Download the freshest `.shp.zip`-File.
...
`ogr2ogr` is available is you `brew install gdal` on macOS.

After this you have a bunch of CSV files, with a bijective BFS_NUMMER and some more information.
